...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  loadSprite("rocketdog", "sprites/rocketdog.png", {
    sliceX: 2,
    anims: {
      "right": {
        from: 0,
  ...
  loadSprite("gunnerdog", "sprites/gunnerdog.png", {
    sliceX: 2,
    anims: {
      "right": {
        from: 0,
  ...
  scene("game", () => {
    ...
    var cat = void 0;
    var speed_x2 = void 0;
    var jump_speed2 = void 0;
    var cathealth = void 0;
    var cooldowntime2 = void 0;
    ...
    var dog = void 0;
    var speed_x = void 0;
    var jump_speed = void 0;
    var doghealth = void 0;
    var cooldowntime = void 0;
    ...
    function shootRocket(direction) {
      ...
      rocket.on("death", () => {
        ...
        destroy(rocket);
        wait(1, () => {
          if (rocketeffect != void 0) {
            rocketeffect.destroy();
          }
        });
      });
    }
    __name(shootRocket, "shootRocket");
    ...
    function swingSword() {
      ...
      sword.onCollide("cat", (cat2) => {
        cat2.hurt(1);
      });
    }
    __name(swingSword, "swingSword");
